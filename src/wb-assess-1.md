...
'console.log' outputs something to the terminal. 'Return' returns a value from a function.

**_What's the difference between defining and calling a function?_**

When you define a function you define how it works what parameters
it has and what it returns. When you call a function it makes the
program execute it.
...
A logical data type which can be true or false. Other datatypes
can also have boolean values, we call these truthy or falsey values. 

**_Array_**

A collection of values. An array is zero indexed (meaning the index
